                                ...
                                <div class="row image-box hotel listing-style1">
                                	<?php
										for ($x = 0; $x < count($developmentProjects); $x++) {
											echo '<div class="col-sm-6 col-md-4 anjuProperty" data-price="' . $developmentProjects[$x]->lowestPrice . '" data-property-type="' . $developmentProjects[$x]->propertyType . '" data-city="' . $developmentProjects[$x]->city . '">';
		                                    echo '	 <article class="box">';
		                                    echo '        <figure>';
		                                    echo '            <a href="ajax/slideshow-popup.html" class="hover-effect popup-gallery"><img width="270" height="160" alt="" src="images/projects/' . $developmentProjects[$x]->imageFolder . '/main.jpg"></a>';
		                                    echo '        </figure>';
		                                    echo '        <div class="details">';
		                                    echo '            <span class="price">';
		                                    echo '                <small>price</small>';
		                                    echo '                ' . $developmentProjects[$x]->lowestPrice . ' ';
		                                    echo '            </span>';
		                                    echo '            <h4 class="box-title">' . $developmentProjects[$x]->name . '<small>' . $developmentProjects[$x]->location . '</small></h4>';
		                                    echo '            <div class="feedback">';
		                                    echo '                <div data-placement="bottom" data-toggle="tooltip" class="five-stars-container" title="4 stars"><span style="width: 80%;" class="five-stars"></span></div>';
		                                    echo '                <span class="review">270 reviews</span>';
		                                    echo '            </div>';
		                                    echo '            <p class="description">' . $developmentProjects[$x]->description . '</p>';
		                                    echo '            <div class="action">';
		                                    echo '                <a class="button btn-small" href="project-detailed.php?id=' . $developmentProjects[$x]->id . '">SELECT</a>';
		                                    echo '                <a class="button btn-small yellow popup-map" href="#" data-box="48.856614, 2.352222">VIEW ON MAP</a>';
		                                    echo '            </div>';
		                                    echo '        </div>';
		                                    echo '    </article>';
		                                    echo '</div>';
