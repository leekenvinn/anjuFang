...
export class AppComponent implements OnInit, AfterViewInit {
    ...
    _showProductSubmenu: boolean = false;
    ...
    set showProductSubmenu(value: boolean) {
        this._showProductSubmenu = value;
    }

    get showProductSubmenu() {
        return this._showProductSubmenu;
    }
    ...
    showProduct() {
        this.alertService.showMessage("aa Ended!", "", MessageSeverity.default);
    }
