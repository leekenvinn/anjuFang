...
namespace DAL
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<ProductType>().Property(p => p.Name).IsRequired().HasMaxLength(100);
            builder.Entity<ProductType>().Property(p => p.Description).HasMaxLength(500);
            builder.Entity<ProductType>().ToTable($"App{nameof(this.ProductType)}");
